...
if __name__ == '__main__':
    ...
    iec = ExcelClient(configInfo['uploadFile'], sourceIndex = (0,1,2,3))
    oec = ExcelClient(outputDir = configInfo['debugFile'], outputHeader = ['case_num', 'case_id', 'date', 'description'])
    lc = LogClient()
    lineNum = 2
    ...
    print 'Upload succeeded! Please check %s if you see something failed'%configInfo['debugFile']
