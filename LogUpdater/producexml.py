...
if __name__ == '__main__':
    ...
    ec = ExcelClient(outputDir = configInfo['metaStorage'], outputHeader = sum([header, ['case_name']], []))
    ...
    print 'Output succeeded! Please check %s before run the upload.py'%configInfo['metaStorage']
